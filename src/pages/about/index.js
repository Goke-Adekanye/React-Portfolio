      ...
      <div className="container">
        ...
        <div className="row align-items-center">
          ...
          <div className="about-text">
            <p>
              Hi, I’m Goke Adekanye, a professional Frontend Web Developer based
              in Lagos State, Nigeria. As a graduate of Computer Science (BSc.),
              I am passionate about leveraging my solid background in
